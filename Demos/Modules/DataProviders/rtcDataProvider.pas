...
begin
  ...
  begin
    ...
    if (Param.asString['Action'] <> 'desk')
      and Users.HostIsService(Param.asWideString['User']) then //Åñëè ïîäêëþ÷åíèå ê ñëóæáå ïåðåäà÷è ôàéëîâ èëè ÷àòà è ó ñëóæáû óêàçàí àêòèâíûé êîíñîëüíûé êëèåíò ïåðåäàåì åãî
    begin
...
//        AddParam(SP, '@GroupName', ftWideString, pdInput, 'Ìîè êîìïüþòåðû');
...
//        AddParam(SP, '@UID', ftGUID, pdOutput, SP.Parameters.ParamValues['@UID']);
        ...
        SP.Parameters.ParamByName('@GroupName').Value := 'Мои устройства';
