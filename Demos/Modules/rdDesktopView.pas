...
procedure TrdDesktopViewer.AddProgressDialogToList(ATaskId: TTaskId; AProgressDialog: PProgressDialog; AUserName: String);
var
...
function TrdDesktopViewer.GetProgressDialog(ATaskId: TTaskId): PProgressDialog;
var
  i: Integer;
begin
  Result := nil;
