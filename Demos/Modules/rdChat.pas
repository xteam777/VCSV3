...
procedure TrdChatForm.ChangeLockedState(var Message: TMessage);
begin
...
begin
  if myUI.UserDesc <> '' then
    pTitle.Caption := myUI.UserDesc + ' - Чат'
  else
    pTitle.Caption := GetUserFromFromUserName(myUI.UserName) + ' - Чат';
end;
...
//  Caption:=mode+'Chat - '+myUI.UserName;
//  if myUI.UserDesc <> '' then
