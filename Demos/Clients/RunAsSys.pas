...
uses
  ...
  function ExecuteAsSystem(AFileName, AParameters: String) : Integer;
...
//        end;
        ...
        begin
          ...
          Shell.lpVerb := 'SuRun';
          Shell.lpFile := PChar(AFileName); //PChar(ParamStr(0));
          Shell.lpParameters := PChar(AParameters); //PChar(Parameters);
...
#define RETVAL_CANCELLED    4
        ...
        begin
          ...
          JwShellExecute(0, //const hWnd: HWND;
            AFileName, //ParamStr(0), //FileName,
            AParameters, //Parameters, //Parameters,
            '', //Directory: TJwString;
            0, //ShowCmd: Integer;
            [sefIgnoreElevationIfNotAvailable]//Flags : TJwShellExecuteFlags = [sefNoClosehProcess]): HANDLE;
          );
