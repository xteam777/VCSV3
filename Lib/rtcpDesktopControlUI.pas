...
type
  ...
  var
    ...
    FOnInit: TRtcPDesktopControlUIEvent;
    ...
    FOnReadStart: TRtcPDesktopControlUIEvent;
    FOnRead: TRtcPDesktopControlUIEvent;
    FOnReadUpdate: TRtcPDesktopControlUIEvent;
    FOnReadStop: TRtcPDesktopControlUIEvent;
    FOnReadCancel: TRtcPDesktopControlUIEvent;

    FOnWriteStart: TRtcPDesktopControlUIEvent;
    FOnWrite: TRtcPDesktopControlUIEvent;
    FOnWriteStop: TRtcPDesktopControlUIEvent;
    FOnWriteCancel: TRtcPDesktopControlUIEvent;

    FOnCallReceived: TRtcPDesktopControlUIEvent;
  ...
  published
    ...
    property OnSendStart: TRtcPDesktopControlUIEvent read FOnReadStart
      write FOnReadStart;
    { We are sending a file.
      Obj = This TRtcPFileTransferUI component
      TRtcPFileTransferUI(Obj).Send_... = Sending files info }
    property OnSend: TRtcPDesktopControlUIEvent read FOnRead write FOnRead;
    { We are sending a file, need to update send info.
      Obj = This TRtcPFileTransferUI component
      TRtcPFileTransferUI(Obj).Send_... = Sending files info }
    property OnSendUpdate: TRtcPDesktopControlUIEvent read FOnReadUpdate
      write FOnReadUpdate;
    { We have stopped sending a file (file sent).
      Obj = This TRtcPFileTransferUI component
      TRtcPFileTransferUI(Obj).Send_... = Sending files info }
    property OnSendStop: TRtcPDesktopControlUIEvent read FOnReadStop
      write FOnReadStop;
    { File sending was cancelled by user.
      Obj = This TRtcPFileTransferUI component
      TRtcPFileTransferUI(Obj).Send_... = Sending files info }
    property OnSendCancel: TRtcPDesktopControlUIEvent read FOnReadCancel
      write FOnReadCancel;

    { We have started receiving a new file.
      Obj = This TRtcPFileTransferUI component
      TRtcPFileTransferUI(Obj).Recv_... = Receiving files info }
    property OnRecvStart: TRtcPDesktopControlUIEvent read FOnWriteStart
      write FOnWriteStart;
    { We are receiving a file.
      Obj = This TRtcPFileTransferUI component
      TRtcPFileTransferUI(Obj).Recv_... = Receiving files info }
    property OnRecv: TRtcPDesktopControlUIEvent read FOnWrite write FOnWrite;
    { We have stopped receiving a file (file received).
      Obj = This TRtcPFileTransferUI component
      TRtcPFileTransferUI(Obj).Recv_... = Receiving files info }
    property OnRecvStop: TRtcPDesktopControlUIEvent read FOnWriteStop
      write FOnWriteStop;
    { File receiving was cancelled by user.
      Obj = This TRtcPFileTransferUI component
      TRtcPFileTransferUI(Obj).Recv_... = Receiving files info }
    property OnRecvCancel: TRtcPDesktopControlUIEvent read FOnWriteCancel
      write FOnWriteCancel;

    { Call received from "user".
      Obj = This TRtcPFileTransferUI component
      TRtcPFileTransferUI(Obj).Params = Data Received (RtcFunctionInfo object) }
    property OnCallReceived: TRtcPDesktopControlUIEvent read FOnCallReceived
...
//FileTrans+
procedure TRtcPDesktopControlUI.InitSend;
begin
  FSendFilesCnt := 0;
  FSendFolders.Clear;
  FSendFileName := '';
...
procedure TRtcPDesktopControlUI.InitRecv;
begin
  FRecvFilesCnt := 0;
  FRecvFolders.Clear;
  FRecvFileName := '';
...
procedure TRtcPDesktopControlUI.Call_Init(Sender: TObject);
begin
  InitSend;
  InitRecv;
...
procedure TRtcPDesktopControlUI.Call_ReadStart(Sender: TObject;
...
procedure TRtcPDesktopControlUI.Call_Read(Sender: TObject;
  const fname, fromfolder: String; size: int64);
begin
  if fname = '' then
    raise Exception.Create('Folder undefined');
...
procedure TRtcPDesktopControlUI.Call_ReadStop(Sender: TObject;
  const fname, fromfolder: String; size: int64);
begin
  if fname = '' then
    raise Exception.Create('Folder undefined');
...
procedure TRtcPDesktopControlUI.Call_ReadCancel(Sender: TObject;
  const fname, fromfolder: String; size: int64);
begin
  if fname = '' then
    raise Exception.Create('Folder undefined');
...
function TRtcPDesktopControlUI.GetSendETA: String;
var
  NowTime: Cardinal;
  XSpeed: double;
  LeftTime: Cardinal;
...
function TRtcPDesktopControlUI.GetSendTotalTime: String;
var
  NowTime: Cardinal;
  LeftTime: Cardinal;
begin
...
function TRtcPDesktopControlUI.GetSendKBit: longint;
var
  NowTime: Cardinal;
begin
  Result := 0;
...
procedure TRtcPDesktopControlUI.Call_ReadUpdate(Sender: TObject);
begin
...
procedure TRtcPDesktopControlUI.Call_WriteStart(Sender: TObject;
...
function TRtcPDesktopControlUI.GetRecvETA: String;
var
  NowTime: Cardinal;
  XSpeed: double;
  LeftTime: Cardinal;
...
function TRtcPDesktopControlUI.GetRecvTotalTime: String;
var
  NowTime: Cardinal;
  LeftTime: Cardinal;
begin
...
function TRtcPDesktopControlUI.GetRecvKBit: longint;
var
  NowTime: DWORD;
begin
  Result := 0;
...
procedure TRtcPDesktopControlUI.Call_Write(Sender: TObject;
  const fname, tofolder: String; size: int64);
begin
  if fname = '' then
    raise Exception.Create('Folder undefined');
...
procedure TRtcPDesktopControlUI.Call_WriteStop(Sender: TObject;
  const fname, tofolder: String; size: int64);
begin
  if fname = '' then
    raise Exception.Create('Folder undefined');
...
procedure TRtcPDesktopControlUI.Call_WriteCancel(Sender: TObject;
  const fname, tofolder: String; size: int64);
begin
  if fname = '' then
    raise Exception.Create('Folder undefined');
...
procedure TRtcPDesktopControlUI.Call_CallReceived(Sender: TObject;
...
procedure TRtcPDesktopControlUI.xOnInit(Sender, Obj: TObject);
begin
  FOnInit(self);
end;

procedure TRtcPDesktopControlUI.xOnRead(Sender, Obj: TObject);
begin
  FOnRead(self);
end;

procedure TRtcPDesktopControlUI.xOnReadStart(Sender, Obj: TObject);
begin
  FOnReadStart(self);
end;

procedure TRtcPDesktopControlUI.xOnReadStop(Sender, Obj: TObject);
begin
  FOnReadStop(self);
end;

procedure TRtcPDesktopControlUI.xOnReadCancel(Sender, Obj: TObject);
begin
  FOnReadCancel(self);
end;

procedure TRtcPDesktopControlUI.xOnReadUpdate(Sender, Obj: TObject);
begin
  FOnReadUpdate(self);
end;

procedure TRtcPDesktopControlUI.xOnWrite(Sender, Obj: TObject);
begin
  FOnWrite(self);
end;

procedure TRtcPDesktopControlUI.xOnWriteStart(Sender, Obj: TObject);
begin
  FOnWriteStart(self);
end;

procedure TRtcPDesktopControlUI.xOnWriteStop(Sender, Obj: TObject);
begin
  FOnWriteStop(self);
end;

procedure TRtcPDesktopControlUI.xOnWriteCancel(Sender, Obj: TObject);
begin
  FOnWriteCancel(self);
end;

procedure TRtcPDesktopControlUI.xOnCallReceived(Sender, Obj: TObject);
begin
