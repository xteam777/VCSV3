...
//          Assert(longword(ptrDest) - longword(ptrOrig) + w^ * 4 <= BlockSize);  //-sstuman. ошибка и кривой скрин
...
//          Assert(longword(ptrDest) - longword(ptrOrig) + dw^ * 4 <= BlockSize); //-sstuman. ошибка и кривой скрин
...
//          Assert(longword(ptrDest) - longword(ptrOrig) + b^ * 4 <= BlockSize);  //-sstuman. ошибка и кривой скрин
...
//          Assert((len >= b^ * 4) and (longword(ptrDest) - longword(ptrOrig) + b^ * 4 <= BlockSize)); //-sstuman. ошибка и кривой скрин
...
//          Assert((len >= w^ * 4) and (longword(ptrDest) - longword(ptrOrig) + w^ * 4 <= BlockSize));  //-sstuman. ошибка и кривой скрин
...
//          Assert((len >= dw^ * 4) and (longword(ptrDest) - longword(ptrOrig) + dw^ * 4 <= BlockSize)); //-sstuman. ошибка и кривой скрин
...
//          Assert((len >= b^) and (longword(ptrDest) - longword(ptrOrig) + b^ <= BlockSize));  //-sstuman. ошибка и кривой скрин
